...
public  class ListModelTransformer < ITEM_TYPE extends DataModel< ITEM_TYPE > > extends DataTransformer < ListModel< ITEM_TYPE > > {

	
	private final DataTransformer < ITEM_TYPE > itemTransformer;
	
	
	public ListModelTransformer( String nodeKey, DataTransformer < ITEM_TYPE > itemTransformer ) {
		super( nodeKey );
