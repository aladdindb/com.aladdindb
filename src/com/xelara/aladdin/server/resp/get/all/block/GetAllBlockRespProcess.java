package com.xelara.aladdin.server.resp.get.all.block;
...
public class GetAllBlockRespProcess < UDM extends DataModel < UDM > > extends RespProcess< UDM > { 
	...
	private void resp( String cmdSessionID, String direction ) {
		...
		switch( LineNavigator.DIRECTION.valueOf(direction) ) {
