...
public class GetByIdReqProcess < UDM extends DataModel < UDM > > extends ReqProcess< UDM, Unit< UDM > > { 
	...
	public void run() {
		...
		var req 		= new GetByIdReq		( this.unitsChanel.unitGroupID, this.unitID );
		var reqParser 	= new GetByIdReqParser	();
